...
all_tiles = read_FitsCat(
    os.path.join(workdir, admin["tiling_pmem"]["rpath"], admin["tiling_pmem"]["tiles_filename"])
)
hpix_tile_lists = np.load(
    os.path.join(workdir, admin["tiling_pmem"]["rpath"], admin["tiling_pmem"]["tiles_npy"]),
    allow_pickle=True,
)
hpix_core_lists = np.load(
    os.path.join(workdir, admin["tiling_pmem"]["rpath"], admin["tiling_pmem"]["sky_partition_npy"]),
    allow_pickle=True,
)
