...
if not os.path.isfile(gbkg_filename):
    ...
    global_bkg_end = time.time()
    print('Time for Global bkg computation: ', global_bkg_end-global_bkg_start, flush=True)
